...
def submit():
        ...
        if password == confirm_password :
            ...
            if not check_lower:
                messagebox.showerror('Error','\nYour password must have lower characters.')
                messagebox.CANCEL

            elif not check_upper:
                messagebox.showerror('Error','\nYour password must have capital characters.')
                messagebox.CANCEL

            elif not check_digit:
                messagebox.showerror('Error','\nYour password must have numerical characters.')
                messagebox.CANCEL

            elif not check_punc:
                messagebox.showerror('Error','\nYour password must have punctuation characters.')
                messagebox.CANCEL

            elif not check_correct:
                messagebox.showerror('Error','\nInvalid password.')
                messagebox.CANCEL
